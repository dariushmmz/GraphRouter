...
ROUTER_DATA_PATH = "data/router_data_nlgFA.csv"
LLM_EMBEDDING_PATH = "configs/llm_description_embedding_nlgFA.pkl"
...
df.to_csv(ROUTER_DATA_PATH_NORMALIZED, index=False)
...
with open(LLM_EMBEDDING_PATH_NORMALIZED, "wb") as f:
